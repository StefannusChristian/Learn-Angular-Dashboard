...
make the sales by category component  
`change sales-by-category-component.html`

```html
<div class="chart-container" [chart]="chart"></div>
```

`change sales-by-category-component.scss`
...
`change sales-by-category-component.ts`
```typescript
...
change the `last-few-transactions.component.html`
...
change the `top-three-products.component.html`
```html
<div class="chart-container" [chart]="chart"></div>
```

change the `top-three-products.component.scss`
```scss
.chart-container {
  padding: 20px;
}
...
change the `top-three-products.component.ts`
```typescript
import { Component, OnInit } from '@angular/core';
import { Chart } from 'angular-highcharts';
